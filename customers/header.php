  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="#" class="navbar-brand">
        <img src="<?= $base_url?>images/goods.jpeg" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Product Type</a>
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="<?= $base_url.'customers/home.php'?>?pt=Furniture" class="dropdown-item">Furnitures</a></li>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            ?>
            <a href="<?= $base_url.'customers/my_orders.php'?>?st=cart" class="dropdown-item dropdown-footer">See My Cart</a>
          </div>
        </li>
