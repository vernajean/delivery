...
<body>
    <div class="header">
        ...
        <div class="header-right">
            ...
            <a href="<?= $base_url ?>contact.php">About Us</a>
            <a href="<?= $base_url ?>login.php">Login</a>
        </div>
    </div>
    <div class="wrapper">

        <img class="mySlides" src="<?= $base_url ?>images/carousel/carousel (5).jpg">
        <img class="mySlides" src="<?= $base_url ?>images/carousel/carousel (6).jpg">
        <img class="mySlides" src="<?= $base_url ?>images/carousel/carousel (7).jpg">
        <img class="mySlides" src="<?= $base_url ?>images/carousel/carousel (5).jpg">
    </div>
    <script>
        var myIndex = 0;
