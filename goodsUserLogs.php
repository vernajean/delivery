            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="./subGoods/staff/addStaff.php">Add New Staff</a>
                        </nav>
                    </div>
                    ...
                    <!-- LOGS INFORMATION -->
                    <a class="nav-link active" href="goodsUserLogs.php">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        Customer Logs
                    </a>
                    ...
                    <div class="card-body mt-4">
                        <table id="datatablesSimple">
                            <thead>
								...
								if (isset($_GET['delete_id'])) {
									...
									if ($result) {
										echo "<script type='text/javascript'>
												...
												window.location = 'goodsUserLogs.php';
											</script>";
									} else {
										echo "<script type='text/javascript'>
								...
								$sql = "SELECT * FROM logs WHERE subType = 'user (Goods)' "; // Assuming you have an 'id' field for each user
