...
$sql = "SELECT * FROM delivery_db.accounts WHERE id = $id";
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= $base_url?>payments/dashboard.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= $base_url?>payments/orders.php" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Orders
              </p>
          ...
          <!-- <li class="nav-item">
            <a href="<?= $base_url?>payments/sales.php" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Sales
              </p>
