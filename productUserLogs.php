        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #f4cbc6">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <!-- LOGS INFORMATION -->
                    <a class="nav-link active" href="ProductUserLogs.php">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        Customer Logs
                    </a>
                    ...
                    <div class="card-body mt-4">
                        <table id="datatablesSimple">
                            <thead>
								...
								if (isset($_GET['delete_id'])) {
									...
									if ($result) {
										echo "<script type='text/javascript'>
												...
												window.location = 'ProductUserLogs.php';
											</script>";
									} else {
										echo "<script type='text/javascript'>
								...
								$sql = "SELECT * FROM logs WHERE subType = 'user (Product)' "; // Assuming you have an 'id' field for each user
