...
<div id="layoutSidenav">
    ...
    <main>
        ...
        $id = $_SESSION['id'];
        $sql = "SELECT * FROM staff WHERE type = 'staff (Goods)'";
        ...
        <div class="col-xl-4 mt-5 mx-auto" style="width: 600px">
            <div class="card text-white mb-4 " style="background-color: #1f202c">
                <div class="card-header text-center">
                    <h2>Update Account</h2>
                </div>
                <div class="card-body text-center" style="background-color: #a47347">
                    <div class="row">
                        <div class="col-lg-12">
