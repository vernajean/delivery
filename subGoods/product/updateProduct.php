...
<div id="layoutSidenav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #1f202c">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link " href="./allProduct.php">Products Data</a>
    ...
    <main>
        ...
        $id = $_SESSION['id'];
        $sql = "SELECT * FROM product WHERE product_type = 'Goods'";
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE product SET product_name='$name', image='$image' WHERE id= '$id'";
                        ...
                        <div class="col-lg-12">
                            <form action="updateProduct.php" method="POST">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div>
                                        <input type="file" class="form-control border border-info" id="image" name="image" value="<?php echo $users['image']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="cal-icon">
                                        <input type="text" class="form-control border border-info" id="name" name="name" value="<?php echo $users['product_name']; ?>" >
                                    </div>
                                </div>
                                
                                <div class="text-center">
                                    <button type="submit" name="submit" id="submit" class="btn btn-success btn-lg mt-4">Update Product</button>
                                </div>
                            </form>
                        </div>
                    </div>
