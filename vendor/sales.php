              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php 
                    $query = "SELECT o.*,d.*,o.id order_id,a.*,p.image,p.description,p.product_name,p.price,p.quantity pqty FROM orders as o INNER JOIN product as p ON o.product_id = p.id INNER JOIN accounts as a ON a.id = o.buyer_id LEFT JOIN payment_db.delivery as d ON o.id = d.order_id WHERE o.seller_id = 1 AND (order_status=2 OR order_status=3)";
