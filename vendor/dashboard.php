                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                      <?php 
                        ...
                        $date = date('Y-m-d');
                        $query = "SELECT o.*,p.image,p.description,p.product_name FROM orders as o INNER JOIN product as p ON o.product_id = p.id WHERE o.seller_id = '$id' AND o.order_status=3";
                        $result = $connection->query($query);
                        echo $result->num_rows;
                      ?>
                    </span>
