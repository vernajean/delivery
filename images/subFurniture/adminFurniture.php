        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #704e2e">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <!-- DASHBOARD -->
                    <a class="nav-link active" href="./adminFurniture.php">
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6 mt-4">
                <div class="card text-white mb-4" style="background-color: #849483">
                    <div class="card-body text-center">
                        <h3>Total Number of Customers </h3>
                        <?php

                        $query = "SELECT * FROM users WHERE user_type = 'user (Furniture)' ";
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #704e2e">
            ...
            <div class="col-xl-4 col-md-6 mt-4">
                <div class="card text-white mb-4" style="background-color: #849483">
                    <div class="card-body text-center">
                        ...
                        $query = "SELECT * FROM product WHERE product_type = 'Furniture' ";
                        $run_query = mysqli_query($connection, $query);
            ...
            <div class="col-xl-4 col-md-6 mt-4">
                <div class="card text-white mb-4" style="background-color: #849483">
                    <div class="card-body text-center">
                        ...
                        $query = "SELECT * FROM users WHERE user_type = 'staff (Furniture)' ";
                        $run_query = mysqli_query($connection, $query);
