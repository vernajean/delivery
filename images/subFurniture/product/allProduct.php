            ...
            <div class="content container-fluid">
                ...
                <div class="card mb-4 mt-3">
                    ...
                    <tbody>
                            ...
                            $sql = "SELECT * FROM product WHERE product_type = 'Furniture'"; // Assuming you have an 'id' field for each user
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    echo "<a href='update.php?id=" . $row['id'] . "' class='btn btn-update btn-primary'>Update</a> ";
