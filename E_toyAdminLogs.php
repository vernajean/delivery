        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #f22b1e">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <!-- DASHBOARD -->
                    <a class="nav-link " href="./subE-toy/adminE-toy.php">
                    ...
                    <div class="collapse" id="collapseCustomers" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="./subE-toy/customer/allCustomer.php">Customers Information</a>
                            <a class="nav-link" href="./subE-toy/customer/addCustomer.php">Add New Customers</a>
                        </nav>
                    </div>
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="./subE-toy/staff/allStaff.php">Staff's Data</a>
                            <a class="nav-link" href="./subE-toy/staff/addStaff.php">Add New Staff</a>
                        </nav>
                    </div>
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./subE-toy/product/allProduct.php">Products Data</a>
                        <a class="nav-link" href="./subE-toy/product/addProduct.php">Add New Product</a>
                        </nav>
                    </div>
                    ...
                    <a class="nav-link active" href="E_toyUserLogs.php">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        My Logs
                    </a>
                    ...
                    <div class="card-body mt-4">
                        <table id="datatablesSimple">
                            <thead>
								...
								if (isset($_GET['delete_id'])) {
									...
									if ($result) {
										echo "<script type='text/javascript'>
												...
												window.location = 'E_toyAdminLogs.php';
											</script>";
									} else {
										echo "<script type='text/javascript'>
								...
								$sql = "SELECT * FROM logs WHERE subType = 'admin (E-toy)' "; // Assuming you have an 'id' field for each user
