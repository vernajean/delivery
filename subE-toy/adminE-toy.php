...
<body class="sb-nav-fixed">
    <!--===========================   NAVBAR   =====================================-->
        ...
        <!--================= Change color background (style="background-color: #240c0b")============================-->
...
<div id="layoutSidenav">
    <div id="layoutSidenav_nav">
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: #f22b1e" id="sidenavAccordion">
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6 mt-4">
                ...
                <div class="card text-white mb-4" style="background-color: #fb6d41">
                    <div class="card-body text-center">
                        <h3>Number of Customers </h3>
                        <?php
                        include('../conn.php');

                        $query = "SELECT * FROM users WHERE user_type = 'user (E-toy)' ";
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #f22b1e">
            ...
            <div class="col-xl-4 col-md-6 mt-4">
                ...
                <div class="card text-white mb-4" style="background-color: #fb6d41">
                    <div class="card-body text-center">
                        ...
                        $query = "SELECT * FROM product WHERE product_type = 'E-toy' ";
                        $run_query = mysqli_query($connection, $query);
            ...
            <div class="col-xl-4 col-md-6 mt-4">
                ...
                <div class="card text-white mb-4" style="background-color: #fb6d41">
                    <div class="card-body text-center">
                        ...
                        $query = "SELECT * FROM users WHERE user_type = 'staff (E-toy)' ";
                        $run_query = mysqli_query($connection, $query);
