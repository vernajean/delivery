                    ...
                    <div class="card-body mt-4">
                        <table id="datatablesSimple">
                            <thead>
								...
								$sql = "SELECT * FROM users WHERE user_type = 'user (E-toy)' "; // Assuming you have an 'id' field for each user
								$result = $connection->query($sql);
								...
								if ($result->num_rows > 0) {
									...
									while ($row = $result->fetch_assoc()) {
										...
										echo "<td>";
                                        echo "<a href='./updateCustomer.php?id=" . $row['id'] . "' class='btn btn-update btn-success'>Update</a> ";
