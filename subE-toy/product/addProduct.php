...
<div id="layoutSidenav">
    ...
    <main>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO product (product_name, image, product_type) VALUES ('$name', '$image', '$type')";
        ...
        <div class="col-xl-4 mt-2 mx-auto" style="width: 600px">
            <div class="card text-white mb-4">
                <div class="card-header text-center" style="background-color: #f22b1e">
                    <h1>ADD PRODUCT</h1>
                </div>
                        ...
                        <div class="col-lg-12">
                            <form action="addProduct.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="hidden" id="Type" name="Type" value="E-toy">
                                </div>

                                <div class="text-center">
                                    <button type="submit" name="submit" id="submit" class="btn btn-success btn-lg mt-4">Add Product </button>
                                </div>
                            </form>
                        </div>
                    </div>
