...
<div id="layoutSidenav">
                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseCustomers" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link" href="../customer/updateCustomer.php">Update Customers</a>
                        </nav>
                    </div>
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="./allStaff.php">Staff's Data</a>
                            <a class="nav-link" href="./addStaff.php">Add New Staff</a>
                            <a class="nav-link active" href="./updateStaff.php">Update Staff</a>
                        </nav>
                    </div>
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        ...
                        <a class="nav-link" href="../product/updateProduct.php">Update Product</a>
                        </nav>
                    </div>
    ...
    <main>
        ...
        $id = $_SESSION['id'];
        $sql = "SELECT * FROM staff WHERE type = 'staff (Product)'";
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE staff SET name='$name', address='$address', email='$email', number='$number', role='$role' WHERE id= '$id'";
        ...
        <div class="col-xl-4 mt-5 mx-auto" style="width: 600px">
            <div class="card text-white mb-4" style="background-color: #f4cbc6">
                <div class="card-header text-center">
                    <h2>Update Account</h2>
                </div>
                <div class="card-body text-center" style="background-color: #f9dce8">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="updateStaff.php" method="POST">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="cal-icon">
                                        <input type="text" class="form-control border border-info" id="name" name="name" value="<?php echo $users['name']; ?>" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group mt-3">
							        <label>Role</label>
								    <select class="form-control border border-info" id="role" name="role" required>
									    <option value="Manager" <?php if ($users['role'] === 'Manager') echo 'selected'; ?>>Manager</option>
									    <option value="Staff" <?php if ($users['role'] === 'Staff') echo 'selected'; ?>>Staff</option>
									    <option value="Room Cleaners" <?php if ($users['role'] === 'Room Cleaners') echo 'selected'; ?>>Room Cleaners</option>
									    <option value="Accountant" <?php if ($users['role'] === 'Accountant') echo 'selected'; ?>>Accountant</option>
									    <option value="Receiptionalist" <?php if ($users['role'] === 'Receiptionalist') echo 'selected'; ?>>Receiptionalist</option>
								    </select>
						        </div>
                                
                                <div class="text-center">
                                    <button type="submit" name="submit" id="submit" class="btn btn-success btn-lg mt-4">Update Staff</button>
                                </div>
                            </form>
                        </div>
                    </div>
