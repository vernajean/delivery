...
<div id="layoutSidenav">
            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <a class="nav-link active" href="./addStaff.php">Add New Staff</a>
                        </nav>
                    </div>
    ...
    <main>
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO staff (name, address, email, number, role, type) VALUES ('$name', '$address', '$email', '$number', '$role', '$type')";
                        ...
                        <div class="col-lg-12">
                            <form action="addStaff.php" method="POST">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div class="cal-icon">
                                        <input type="number" class="form-control border border-info" id="number" name="number" autocomplete="off" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="hidden" id="userType" name="userType" value="staff (Product)">
                                </div>

                                <div class="text-center">
                                    <button type="submit" name="submit" id="submit" class="btn btn-success btn-lg mt-4">Add Staff </button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <footer class="py-4 bg-light mt-auto">
            <div class="container-fluid px-4">
                <div class="d-flex align-items-center justify-content-between small">
                    <div class="text-muted">Copyright &copy; Delivery 2024</div>
                    <div>
