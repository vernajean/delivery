                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseCustomers" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link active" href="./allCustomer.php">Customers Information</a>
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center ">
                        <div class="col ">
                            <div class="mt-4">
                                <h1 class="card-title float-left mt-2 text-center ">ALL CUSTOMER</h1>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body mt-4">
                        <table id="datatablesSimple">
                            <thead>
								...
								$sql = "SELECT * FROM users WHERE user_type = 'user (Furniture)' "; // Assuming you have an 'id' field for each user
								$result = $connection->query($sql);
								$connection->query("SET @num := 0");
								$connection->query("UPDATE users SET id = @num := @num + 1");
								...
								if ($result->num_rows > 0) {
									...
									while ($row = $result->fetch_assoc()) {
										...
										echo "<td>";
                                        echo "<a href='./updateCustomer.php?id=" . $row['id'] . "' class='btn btn-update btn-primary'>Update</a> ";
										echo "<a href='?delete_id=" . $row['id'] . "' class='btn btn-delete btn-danger' onclick='return confirm(\"Are you sure you want to delete this Customer?\")'>Delete</a>";
										echo "</td>";
										echo "</tr>";
									}
								} else {
