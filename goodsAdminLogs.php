        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #1f202c">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <!-- DASHBOARD -->
                    <a class="nav-link " href="./subGoods/adminGoods.php">
                    ...
                    <div class="collapse" id="collapseCustomers" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="./subGoods/customer/allCustomer.php">Customers Information</a>
                            <a class="nav-link" href="./subGoods/customer/addCustomer.php">Add New Customers</a>
                        </nav>
                    </div>
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="./subGoods/staff/allStaff.php">Staff's Data</a>
                            <a class="nav-link" href="./subGoodsy/staff/addStaff.php">Add New Staff</a>
                        </nav>
                    </div>
                    ...
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="./subGoods/product/allProduct.php">Products Data</a>
                        <a class="nav-link" href="./subGoods/product/addProduct.php">Add New Product</a>
                        </nav>
                    </div>
                    ...
                    <a class="nav-link active" href="goodsAdminLogs.php">
                        <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                        My Logs
                    </a>
                    ...
                    <div class="card-body mt-4">
                        <table id="datatablesSimple">
                            <thead>
								...
								if (isset($_GET['delete_id'])) {
									...
									if ($result) {
										echo "<script type='text/javascript'>
												...
												window.location = 'goodsAdminLogs.php';
											</script>";
									} else {
										echo "<script type='text/javascript'>
								...
								$sql = "SELECT * FROM logs WHERE subType = 'admin (Goods)' "; // Assuming you have an 'id' field for each user
