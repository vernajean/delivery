            ...
            if (move_uploaded_file($_FILES["excelFile"]["tmp_name"], $targetFilePath)) {
                ...
                foreach ($reader as $key => $row) {
                    ...
                    if (isset($row[0], $row[1], $row[2], $row[3], $row[4], $row[5], $row[6])) {
                        ...
                        $sql = "INSERT INTO buyer_account (username, password, profile_pic, fullname, age, number,location) VALUES ('$column2', '$column3','$column4', '$column5','$column6', '$column7','$column8')";
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <table class="table align-items-center mb-0">
                  ...
                  <?php
                            ...
                            $checkItems = "SELECT * FROM buyer_account ORDER BY id DESC";
...
<td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['location'] ?></p>
