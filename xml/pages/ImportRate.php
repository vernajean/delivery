            ...
            if (move_uploaded_file($_FILES["excelFile"]["tmp_name"], $targetFilePath)) {
                ...
                foreach ($reader as $key => $row) {
                    ...
                    if (isset($row[0], $row[1], $row[2], $row[3])) {
                        ...
                        $sql = "INSERT INTO irate_ratings (item_id,rate,user) VALUES ('$column2', '$column3','$column4')";
    ...
    <table class="table align-items-center mb-0">
                  <thead >
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Item Id</th>
                  ...
                  <?php
                            ...
                            $checkItems = "SELECT * FROM irate_ratings ORDER BY id DESC";
...
<td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-secondary"><?php echo $getItems['item_id'] ?></span>
                      </td>
                      
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['rate'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['user'] ?></p>
