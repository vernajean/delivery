            ...
            if (move_uploaded_file($_FILES["excelFile"]["tmp_name"], $targetFilePath)) {
                ...
                foreach ($reader as $key => $row) {
                    ...
                    if (isset($row[0], $row[1], $row[2], $row[3], $row[4], $row[5], $row[6])) {
                        ...
                        $sql = "INSERT INTO items (SellerId, img, item_name, item_price, item_source, seller) VALUES ('$column2', '$column3','$column4', '$column5','$column6', '$column7')";
    ...
    <table class="table align-items-center mb-0">
                  <thead >
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Seller ID</th>
                  ...
                  <?php
                            ...
                            $checkItems = "SELECT * FROM items ORDER BY id DESC";
...
<td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-secondary"><?php echo $getItems['SellerId'] ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">   
                            <img src="<?php echo $getItems['img'] ?>" class="avatar avatar-sm me-3 border-radius-lg" alt="user5">                                  
                      </td>
                      <td class="align-middle text-center text-sm">
