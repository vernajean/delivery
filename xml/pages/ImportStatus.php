            ...
            if (move_uploaded_file($_FILES["excelFile"]["tmp_name"], $targetFilePath)) {
                ...
                foreach ($reader as $key => $row) {
                    ...
                    if (isset($row[0], $row[1], $row[2], $row[3], $row[4], $row[5], $row[6],$row[7],$row[8],$row[9],$row[10],$row[11],$row[12])) {
                        ...
                        $sql = "INSERT INTO confirmedorder (cartPendingId,BuyerId,SellerId, item_name, item_price, item_source,buyer_fullname,buyer_location,buyer_age, seller,rider,status) VALUES ('$column2', '$column3','$column4', '$column5','$column6', '$column7','$column8', '$column8','$column10', '$column11', '$column12','$column13')";
    ...
    <table class="table align-items-center mb-0">
                  <thead >
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Cart Pending ID</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Buyer ID</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Seller ID</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Item Source</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Buyer Fullname</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Buyer Location</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Buyer Age</th>
                  ...
                  <?php
                            ...
                            $checkItems = "SELECT * FROM confirmedorder ORDER BY id DESC";
...
<td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-secondary"><?php echo $getItems['cartPendingId'] ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['BuyerId'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['SellerId'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['item_name'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['item_price'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['item_source'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['buyer_fullname'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['buyer_location'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['buyer_age'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['seller'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['rider'] ?></p>
                        
                      </td>
                      <td class="align-middle text-center text-sm">
                        <p class="text-xs font-weight-bold mb-0"><?php echo $getItems['status'] ?></p>
